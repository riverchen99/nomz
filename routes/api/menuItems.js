 ...
 * @param {MenuItem} req.query - Filter containing properties of the desired menuitem. (Automatically filled by Express from URL params)
 ...
 * Creates a menu item.
 * @param {express.Request} req - The express request object.
 * @param {MenuItem} req.body - The desired menuitem to create. (Automatically filled by Express from HTTP request body json)
